...
// Gated to match its only callers (IndexStoreReader / IndexStoreFallback):
// Process lives in corelibs Foundation, and linking that would pull ~51 MiB
// of ICU into every Linux binary.
